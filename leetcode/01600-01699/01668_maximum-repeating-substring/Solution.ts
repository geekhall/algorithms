 ...
 * Example 1:
 *
 * Input: sequence = "ababc", word = "ab" Output: 2 Explanation: "abab" is a substring in " abab c".
 *
 * Example 2:
 *
 * Input: sequence = "ababc", word = "ba" Output: 1 Explanation: "ba" is a substring in "a ba bc". "baba" is not a substring in "ababc".
 *
 * Example 3:
 *
...
function maxRepeating(sequence: string, word: string): number {
  let k = 0
  let tempword = word
  while (sequence.indexOf(tempword) !== -1) {
    k++
    tempword += word
  }
  return k
