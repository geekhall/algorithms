 ...
 * Example 1:
 * 
 * Input: n = 12, k = 3 Output: 3 Explanation: Factors list is [1, 2, 3, 4, 6, 12], the 3 rd factor is 3.
 * 
 * Example 2:
 * 
 * Input: n = 7, k = 2 Output: 7 Explanation: Factors list is [1, 7], the 2 nd factor is 7.
 * 
 * Example 3:
 * 
